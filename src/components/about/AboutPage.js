    ...
    <section className={styles.container}>
      <div>
        ...
        <p>
          ...
          descubra destinos únicos, planeje uma jornada inesquecível por essa
          região encantadora. Prepare-se para desbravar a África Ocidental e
          criar memórias extraordinárias que durarão a vida toda!
        </p>
      </div>
    </section>
  );
